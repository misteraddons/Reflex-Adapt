...
// Windows mode.
// #define BTN_A      (1 <<  0) //BTN_SOUTH
// #define BTN_B      (1 <<  1) //BTN_EAST
// #define BTN_X      (1 <<  2) //BTN_NORTH
// #define BTN_Y      (1 <<  3) //BTN_WEST
// #define BTN_TL     (1 <<  4)
// #define BTN_TR     (1 <<  5)
// #define BTN_TL2    (1 <<  6)
// #define BTN_TR2    (1 <<  7)
...
//Linux mode.
//Works on MiSTer but looks like buttons X/Y are swapped on other linux systems.
#define BTN_A      (1 <<  0) //BTN_SOUTH
#define BTN_B      (1 <<  1) //BTN_EAST
#define BTN_C      (1 <<  2)
#define BTN_Y      (1 <<  3) //BTN_WEST
#define BTN_X      (1 <<  4) //BTN_NORTH
#define BTN_Z      (1 <<  5)
#define BTN_TL     (1 <<  6)
#define BTN_TR     (1 <<  7)
#define BTN_TL2    (1 <<  8)
#define BTN_TR2    (1 <<  9)
#define BTN_SELECT (1 << 10)
#define BTN_START  (1 << 11)
#define BTN_MODE   (1 << 12)
#define BTN_THUMBL (1 << 13)
#define BTN_THUMBR (1 << 14)
