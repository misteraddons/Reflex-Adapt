...
ThreedoPort<THREEDOPIN_CLOCK, THREEDOPIN_DOUT, THREEDOPIN_DIN> tdo1;
  ...
  const Pad pad3do[] = {
    ...
    { THREEDO_B,     3, 7*6, FACEBTN_ON, FACEBTN_OFF },
    { THREEDO_C,     3, 8*6, FACEBTN_ON, FACEBTN_OFF },
    { THREEDO_A,     3, 6*6, FACEBTN_ON, FACEBTN_OFF },
    { THREEDO_P,     2, 4*6, RECTANGLEBTN_ON, RECTANGLEBTN_OFF },
    { THREEDO_X,     2, 5*6, RECTANGLEBTN_ON, RECTANGLEBTN_OFF },
