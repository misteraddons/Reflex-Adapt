...
SNES.FLAGS = -DENABLE_REFLEX_SNES_FULL
Saturn.FLAGS = -DENABLE_REFLEX_SATURN_FULL
PSX_MiSTer.FLAGS = -DENABLE_REFLEX_PSX_MISTER
PSX_PC.FLAGS = -DENABLE_REFLEX_PSX_PC
PCEngine.FLAGS = -DENABLE_REFLEX_PCE_FULL
...
#MisterCores.FLAGS = -DENABLE_REFLEX_SNES_SIMPLE -DENABLE_REFLEX_SATURN_SIMPLE -DENABLE_REFLEX_PSX_PADS -DENABLE_REFLEX_PCE_SIMPLE -DENABLE_REFLEX_NEOGEO_0MS_DEBOUNCE
