...
Combo22.FLAGS = -DENABLE_REFLEX_SNES -DENABLE_REFLEX_SATURN -DENABLE_REFLEX_N64 -DENABLE_N64_ANALOG_MAX=80 -DENABLE_REFLEX_SMS 
...
Combo24.FLAGS = -DENABLE_REFLEX_SNES -DENABLE_REFLEX_SMS -DENABLE_REFLEX_SATURN -DENABLE_REFLEX_PSX -DENABLE_PSX_GENERAL_OLED
#NES+SNES, Gen+Sat, Neo, GC & PSX
Combo25.FLAGS = -DENABLE_REFLEX_SNES -DENABLE_REFLEX_SATURN -DENABLE_REFLEX_NEOGEO -DENABLE_REFLEX_GAMECUBE -DENABLE_REFLEX_PSX -DENABLE_PSX_GENERAL_OLED
