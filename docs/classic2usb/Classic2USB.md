...
recommended for release setup and MiSTer's normal input menu because it retains
management interfaces, the utility drive, GameControllerDB mapping behavior,
and the specialized MiSTer peripheral paths. XInput and Keyboard remain
...
- USB serial management, WebHID, and the utility drive are available in
  management-capable output modes, normally DInput. Selecting XInput or Keyboard
  as an Auto host preference can require the OLED menu to return to DInput.
