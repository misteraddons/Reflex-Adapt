...
constexpr const hid_mouse_report_t _default_hidmouse = {};
...
uint32_t ps4_last_report_ms = 0;
bool ps4_report_clock_started = false;
...
hid_mouse_report_t _hidmouse = _default_hidmouse;
