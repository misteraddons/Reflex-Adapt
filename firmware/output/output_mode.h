...
enum outputMode_t {
  ...
  OUTPUT_XINPUTW,         // Windows four-child Xbox 360 wireless receiver
  ...
  // Guard: MiSTer/Linux XInput uses the wired two-slot XInput2P runtime. It is
  // intentionally auth-free and must not replace OUTPUT_XINPUT for Xbox 360
  // or the Windows-only four-child OUTPUT_XINPUTW receiver.
  OUTPUT_XINPUT2P,
