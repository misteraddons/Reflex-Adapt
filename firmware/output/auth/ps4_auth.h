...
public:
  ...
  uint32_t challengeReportCount() const { return _f0_report_count; }
  void writeDiagnostics(Print& out) const;
...
private:
  ...
  uint8_t _nonce_id = 0;
  uint8_t _nonce_pages_received = 0;
  uint8_t _cur_auth_page = 0;

  uint32_t _f0_report_count = 0;
  uint32_t _f0_crc_error_count = 0;
  uint32_t _f0_reject_count = 0;
  uint32_t _sign_attempt_count = 0;
  uint32_t _sign_success_count = 0;
  uint32_t _f1_request_count = 0;
  uint32_t _f2_request_count = 0;
  uint32_t _f3_request_count = 0;
  uint32_t _last_sign_us = 0;
