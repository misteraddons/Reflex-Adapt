...
AutoDetectResult detectAutoInputPortWiiOnly(uint8_t port, bool is_hotswap = false);
AutoDetectResult detectAutoInputPortShiftRegisterOnly(uint8_t port, bool is_hotswap = false);
AutoDetectResult detectAutoInputPortJoybusOnly(uint8_t port, bool is_hotswap = false);
AutoDetectResult detectAutoInputPortSaturnSharedBusOnly(uint8_t port, bool is_hotswap = false);
