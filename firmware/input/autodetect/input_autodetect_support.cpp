...
AutoDetectResult detectAutoInputPortWiiOnly(uint8_t port, bool is_hotswap) {
  return AutoDetector::detectPortWiiOnly(port, is_hotswap);
}
...
AutoDetectResult detectAutoInputPortJoybusOnly(uint8_t port, bool is_hotswap) {
  return AutoDetector::detectPortJoybusOnly(port, is_hotswap);
}

AutoDetectResult detectAutoInputPortSaturnSharedBusOnly(uint8_t port, bool is_hotswap) {
  return AutoDetector::detectPortSaturnSharedBusOnly(port, is_hotswap);
}
