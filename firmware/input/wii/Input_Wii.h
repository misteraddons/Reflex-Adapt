...
class RZInputWii : public RZInputModule {
  private:
    ...
    static constexpr uint32_t WII_CONNECT_SETTLE_GRACE_US = 500000;
    ...
    bool publishedController[input_ports] = {};
    uint8_t updateFailCount[input_ports] = {};
    uint8_t handoffFailCount[input_ports] = {};
    ...
    uint32_t connectedAtUs[input_ports] = {};
    ...
    static const uint8_t WII_UPDATE_FAIL_DISCONNECT_THRESHOLD = 200;
