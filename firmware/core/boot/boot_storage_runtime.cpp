...
void applyGlobalBootConfiguration(const GlobalSettingsRecord& settings) {
  ...
  configuredOutputMode = sanitizeConfiguredOutputMode(
      (outputMode_t)settings.configured_output_mode);
...
void initializeCoreRuntimeSettingsFromStorage(const GlobalSettingsRecord& globalSettings,
  ...
  gamecube_l_switch_mode = perModeSettings.gamecube_l_switch_mode;
  analog_mouse_mode = perModeSettings.analog_mouse_mode;
  analog_mouse_speed = perModeSettings.analog_mouse_speed;
...
void initializeMenuRuntimeSettingsFromStorage(const GlobalSettingsRecord& globalSettings,
  ...
  menu_gamecube_l_switch_mode = perModeSettings.gamecube_l_switch_mode;
  menu_analog_mouse_mode = perModeSettings.analog_mouse_mode;
  menu_analog_mouse_speed = perModeSettings.analog_mouse_speed;
  menu_win_output = (uint8_t)readRecordSettingValue(globalSettings, SettingId::WinOutput);
  menu_mister_output = (uint8_t)readRecordSettingValue(globalSettings, SettingId::MisterOutput);
