...
#define BTN_SYSTEM_MENU_HOLD_MS 1500  // Mode hold for System Menu (1.5 seconds)
#define BTN_RESET_LONG_PRESS_MS 3000  // Reset hold for Auto Input (3 seconds)
...
public:
  ButtonHandler(uint8_t pin_num, bool is_active_low = true,
                uint32_t long_press_duration_ms = BTN_SYSTEM_MENU_HOLD_MS);
  void begin();
