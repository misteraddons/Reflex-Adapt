...
ButtonHandler::ButtonHandler(uint8_t pin_num, bool is_active_low,
  ...
  : pin(pin_num),
    ...
    long_press_ms(long_press_duration_ms),
    last_raw(false),
    current_state(false),
    last_change_time(0),
    press_start_time(0),
...
ButtonEvent ButtonHandler::update() {
  ...
  return button_handler_internal::updateState(
    ...
    tap_count, first_tap_time,
    long_press_fired, waiting_for_double_tap,
    long_press_ms, pendingEvent, true
  );
}
...
BootselButtonHandler::BootselButtonHandler()
  : long_press_ms(BTN_RESET_LONG_PRESS_MS),
    last_raw(false),
    current_state(false),
    last_change_time(0),
    press_start_time(0),
...
ButtonEvent BootselButtonHandler::update() {
  ...
  return button_handler_internal::updateState(
    ...
    tap_count, first_tap_time,
    long_press_fired, waiting_for_double_tap,
    long_press_ms, pendingEvent, false
  );
}
